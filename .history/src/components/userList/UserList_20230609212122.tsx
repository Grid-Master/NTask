  ...
  return (
    <div className="userList">
      ...
      <div className="userList__grid">
        <div className="userList__grid-name">Имя</div>
        ...
        {users.map((user) => (
          <>
            <div>{user.name}</div>
            <div>{user.date}</div>
            <div className="userList__table-btn" onClick={() => deleteHandler(user.id)}>
              Удалить
            </div>
            <div className="userList__table-btn" onClick={() => updateHandler(`${user.id}`)}>
              Изменить
            </div>
          </>
        ))}
