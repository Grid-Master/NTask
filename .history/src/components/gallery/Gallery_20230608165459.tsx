  ...
  return (
    <div className="gallery">
      ...
      <ul className="gallery__list">
        {photos.map((photo) => (
          <li onClick={photoPickHandler} key={photo.id} className="gallery__list-item">
            <img
              className={
                photo.isSelected ? 'gallery__list-item-photo-active' : 'gallery__list-item-photo'
              }
